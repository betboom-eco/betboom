...
contract Bonus is Op {
    ...
    uint256 public weekBonusAmount = 1000e18;
    ...
    function addWeekBonus(
        ...
        weekBonus[wID].letBonus = weekBonusAmount;
        ...
        nftPool.mintLET(weekBonusAmount);
        emit AddWeekBonus(wID, weekBonusAmount);
    }
